module InputParse
  ...
  def self.parse_whitespace_case(input)
      input.gsub(/\s+/, "").upcase
    end
  ...
  def self.is_ajacent_horizontally_medium?(input)
  ...
  def self.is_ajacent_vertically_medium?(input)
  ...
  def self.is_valid_placement?(input)
